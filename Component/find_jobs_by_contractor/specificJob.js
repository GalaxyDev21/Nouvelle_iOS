...
import { FalseLoader, GetThoseContractorsWhoseBidOnJob, GetData} from '../../Redux/createJob/jobAction' ;
import { FALSE_GET_MATCHES_CONTRACTORS_OF_HOST_JOB_FLAG, GET_THOSE_CONTRTACTORS_WHOSE_BID_ON_JOB, GET_PROPERTY_CHECKLIST} from '../../Redux/createJob/actionType';
...
class SpecificJob extends Component {
  viewDetails = () => {
    ...
    this.props.navigation.navigate('TabViewOfContractorFindJob', {jobDetails : this.props.item});
  }
  getBiddingContractor = async () => {
