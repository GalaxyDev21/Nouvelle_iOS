...
class CheckListsInFindJob extends Component{
  constructor(props){
    super(props);
    this.state = {
      offset : 0,
  ...
  onViewMore = () => {
    this.setState({
      ...
      formData.append('id', this.props.JobDetails.property.ID);
...
export default connect(mapStateToProps, {FalseLoader, GetData, GetSpecificChecklistDetails})(CheckListsInFindJob);
