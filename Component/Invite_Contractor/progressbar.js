...
export default class ProgressBar extends Component {
    render(){
        ...
        <View style={{ justifyContent : 'center', alignItems : 'center', flexDirection: 'row'}}>
          ...
          <View style={{height: hp('0.5%'), width : hp('10%'), backgroundColor : this.props.stepOneColor}}></View>
          <View style={{height: hp('3%'), width : hp('3%'), borderRadius : 100, backgroundColor : this.props.stepTwoColor}}></View>
          <View style={{height: hp('0.5%'), width : hp('10%'), backgroundColor : this.props.stepTwoColor}}></View>
          <View style={{height: hp('3%'), width : hp('3%'), borderRadius : 100, backgroundColor : this.props.stepThreeColor}}></View>
        </View>
        <View style={{width : hp('31%'), flexDirection : 'row', alignItems : 'center', justifyContent : 'space-between'}}>
          ...
          <Text style={{fontFamily : 'Raleway-SemiBold' , color : this.props.stepThreeColor , fontSize : (12)}}>Step 3</Text>
        </View>
      </View>
    )
    }
