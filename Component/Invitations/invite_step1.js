...
export default class Invite_Step1 extends Component{
  constructor(props){
    super(props);
    this.state = {
      radioSelectedValue : ''
  ...
  nextScreen = () => {
    if(this.state.radioSelectedValue === 0){
      this.props.navigation.navigate('Invite_Step2_Email');
    }
    else if(this.state.radioSelectedValue === 1){
      this.props.navigation.navigate('Invite_Step2_SMS');
    }
  }
  render(){
    return(
      <ImageBackground source={require('../../assets/invite_contractor_bg.jpg')} style={styles.container}>
        ...
        <ProgressBar stepOneColor='#8CC63E' stepTwoColor='#CECECE'/>
